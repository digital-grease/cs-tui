//! Async Rust client for the cyberspace.online API (v0.3.7).
//!
//! Authoritative spec: `docs/api-v0.3.7.md` at the repo root.
...
pub const API_VERSION: &str = "v0.3.7";
